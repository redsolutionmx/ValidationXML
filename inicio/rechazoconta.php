<?php
  ...
  //  $com = "UPDATE Ticket SET Ticket.Estatus='RECHAZADO' WHERE Ticket.Ticket = ".$id.;
	...
	{
		header('location:../extend/alerta.php?msj=archivo rechazado&c=cont&p=bili&t=success');
	}
	else
	{
		header('location:../extend/alerta.php?msj=No pudo ser rechazado&c=cont&p=bili&t=error');
    }
